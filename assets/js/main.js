(function ($) {
  $(document).ready(function () {
    ...
    // Ejemplo: recorrer las filas del Excel
    simulador_ajax.excelData.forEach((row, index) => {
      console.log(`Fila ${index}:`, row);
    });

    // -------------------- //
    // Acceder a un valor específico del Excel
    // Ejemplo: acceder al valor de la columna 2 de la fila 1 (índice base 0)
    let valor = simulador_ajax.excelData[1][2];
    console.log('Valor de la columna 2 de la fila 1:', valor);
